...
#ifndef _DYN_NGSIv2_SUBSCRIBER_H_
#define _DYN_NGSIv2_SUBSCRIBER_H_
...
class DynNGSIv2Subscriber : public ISSubscriber
{
private:
...
public:
    DynNGSIv2Subscriber(const std::string &name, const NGSIv2Params &params);
    ~DynNGSIv2Subscriber() override;
...
#endif // _DYN_NGSIv2_SUBSCRIBER_H_
