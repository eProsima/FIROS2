...
#ifndef _JsonNGSIv2_H_
#define _JsonNGSIv2_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(JsonNGSIv2_SOURCE)
#define JsonNGSIv2_DllAPI __declspec( dllexport )
#else
#define JsonNGSIv2_DllAPI __declspec( dllimport )
#endif // JsonNGSIv2_SOURCE
#else
#define JsonNGSIv2_DllAPI
#endif
#else
#define JsonNGSIv2_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure JsonNGSIv2 defined by the user in the IDL file.
 * @ingroup JSONNGSIV2
 */
class JsonNGSIv2
{
public:
     ...
     */
    eProsima_user_DllExport JsonNGSIv2();
     ...
     * @param x Reference to the object JsonNGSIv2 that will be copied.
     */
    eProsima_user_DllExport JsonNGSIv2(const JsonNGSIv2 &x);
    
    /*!
     * @brief Move constructor.
     * @param x Reference to the object JsonNGSIv2 that will be copied.
     */
    eProsima_user_DllExport JsonNGSIv2(JsonNGSIv2 &&x);
    
    /*!
     * @brief Copy assignment.
     * @param x Reference to the object JsonNGSIv2 that will be copied.
     */
    eProsima_user_DllExport JsonNGSIv2& operator=(const JsonNGSIv2 &x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const JsonNGSIv2& data, size_t current_alignment = 0);
