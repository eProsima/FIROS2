...
bool RobotSndPubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5) {
    ...
    if(force_md5 || RobotSnd::getKeyMaxCdrSerializedSize()>16)    {
        m_md5.init();
